...
png1 <- base64enc::dataURI(file="/share_data/wujm/project/Shiny/CNV/reference_V2.1/chromPng/chr1.png", mime="image/png")
png2 <- base64enc::dataURI(file="/share_data/wujm/project/Shiny/CNV/reference_V2.1/chromPng/chr2.png", mime="image/png")
png3 <- base64enc::dataURI(file="/share_data/wujm/project/Shiny/CNV/reference_V2.1/chromPng/chr3.png", mime="image/png")
...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(width = 3,
      selectInput("product_type", label="产品类型:", choices = c("WES","Panel")),
