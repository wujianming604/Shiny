...
server <- function(input, output, session){
    ...
    observeEvent(input$goButton,{
            #woman
            if(input$sex == "男"){
                sampleDir <- "/share_data/wujm/project/Shiny/CNV/reference_DD/man/"
                ##
                dat <- data.table::fread(paste0(sampleDir,"baseLineCorPercent.txt"),sep='\t',header=TRUE)
                gc_file <- "/share_data/wujm/project/getFastaGC/WES.DD.gc2.txt"
                ##连接数据库，根据检测样本，获取对应的cnn文件
                testSample <- input$sampleName
                conn <- dbConnect(MySQL(), host=dbconfig$host, dbname="DD", user=dbconfig$username, password=dbconfig$password)
                ...
                sampleDir <- "/share_data/wujm/project/Shiny/CNV/reference_DD/woman/"
                ##
                dat <- data.table::fread(paste0(sampleDir,"baseLineCorPercent.txt"),sep='\t',header=TRUE)
                gc_file <- "/share_data/wujm/project/getFastaGC/WES.DD.gc2.txt"
                ##连接数据库，根据检测样本，获取对应的cnn文件
                ...
                #chromStr <- input$chrom
                dataChr1 <- percent_dat[percent_dat$chrom == 'chr1',]
                output$chr1 <- renderPlotly({ggplotly(ggplot(data=dataChr1, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr1$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,249250621) + labs(x='position',y='t score',title="chr1")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr1_chrom <- renderPlot(chromNumber("1"))

                dataChr2 <- percent_dat[percent_dat$chrom == 'chr2',]
                output$chr2 <- renderPlotly({ggplotly(ggplot(data=dataChr2, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr2$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,243199373) + labs(x='position',y='t score',title="chr2")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr2_chrom <- renderPlot(chromNumber("2"))
                dataChr3 <- percent_dat[percent_dat$chrom == 'chr3',]
                output$chr3 <- renderPlotly({ggplotly(ggplot(data=dataChr3, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr3$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,198022430) + labs(x='position',y='t score',title="chr3")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr3_chrom <- renderPlot(chromNumber("3"))
                dataChr4 <- percent_dat[percent_dat$chrom == 'chr4',]
                output$chr4 <- renderPlotly({ggplotly(ggplot(data=dataChr4, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr4$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,191154276) + labs(x='position',y='t score',title="chr4")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr4_chrom <- renderPlot(chromNumber("4"))
                dataChr5 <- percent_dat[percent_dat$chrom == 'chr5',]
                output$chr5 <- renderPlotly({ggplotly(ggplot(data=dataChr5, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr5$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,180915260) + labs(x='position',y='t score',title="chr5")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr5_chrom <- renderPlot(chromNumber("5"))
                dataChr6 <- percent_dat[percent_dat$chrom == 'chr6',]
                output$chr6 <- renderPlotly({ggplotly(ggplot(data=dataChr6, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr6$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,171115067) + labs(x='position',y='t score',title="chr6")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr6_chrom <- renderPlot(chromNumber("6"))
                dataChr7 <- percent_dat[percent_dat$chrom == 'chr7',]
                output$chr7 <- renderPlotly({ggplotly(ggplot(data=dataChr7, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr7$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,159138663) + labs(x='position',y='t score',title="chr7")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr7_chrom <- renderPlot(chromNumber("7"))
                dataChr8 <- percent_dat[percent_dat$chrom == 'chr8',]
                output$chr8 <- renderPlotly({ggplotly(ggplot(data=dataChr8, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr8$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,146364022) + labs(x='position',y='t score',title="chr8")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr8_chrom <- renderPlot(chromNumber("8"))
                dataChr9 <- percent_dat[percent_dat$chrom == 'chr9',]
                output$chr9 <- renderPlotly({ggplotly(ggplot(data=dataChr9, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr9$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,141213431) + labs(x='position',y='t score',title="chr9")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr9_chrom <- renderPlot(chromNumber("9"))
                dataChr10 <- percent_dat[percent_dat$chrom == 'chr10',]
                output$chr10 <- renderPlotly({ggplotly(ggplot(data=dataChr10, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr10$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,135534747) + labs(x='position',y='t score',title="chr10")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr10_chrom <- renderPlot(chromNumber("10"))
                dataChr11 <- percent_dat[percent_dat$chrom == 'chr11',]
                output$chr11 <- renderPlotly({ggplotly(ggplot(data=dataChr11, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr11$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,135006516) + labs(x='position',y='t score',title="chr11")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr11_chrom <- renderPlot(chromNumber("11"))
                dataChr12 <- percent_dat[percent_dat$chrom == 'chr12',]
                output$chr12 <- renderPlotly({ggplotly(ggplot(data=dataChr12, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr12$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,133851895) + labs(x='position',y='t score',title="chr12")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr12_chrom <- renderPlot(chromNumber("12"))
                dataChr13 <- percent_dat[percent_dat$chrom == 'chr13',]
                output$chr13 <- renderPlotly({ggplotly(ggplot(data=dataChr13, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr13$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,115169878) + labs(x='position',y='t score',title="chr13")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr13_chrom <- renderPlot(chromNumber("13"))
                dataChr14 <- percent_dat[percent_dat$chrom == 'chr14',]
                output$chr14 <- renderPlotly({ggplotly(ggplot(data=dataChr14, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr14$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,107349540) + labs(x='position',y='t score',title="chr14")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr14_chrom <- renderPlot(chromNumber("14"))
                dataChr15 <- percent_dat[percent_dat$chrom == 'chr15',]
                output$chr15 <- renderPlotly({ggplotly(ggplot(data=dataChr15, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr15$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,102531392) + labs(x='position',y='t score',title="chr15")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr15_chrom <- renderPlot(chromNumber("15"))
                dataChr16 <- percent_dat[percent_dat$chrom == 'chr16',]
                output$chr16 <- renderPlotly({ggplotly(ggplot(data=dataChr16, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr16$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,90354753) + labs(x='position',y='t score',title="chr16")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr16_chrom <- renderPlot(chromNumber("16"))
                dataChr17 <- percent_dat[percent_dat$chrom == 'chr17',]
                output$chr17 <- renderPlotly({ggplotly(ggplot(data=dataChr17, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr17$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,81195210) + labs(x='position',y='t score',title="chr17")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr17_chrom <- renderPlot(chromNumber("17"))
                dataChr18 <- percent_dat[percent_dat$chrom == 'chr18',]
                output$chr18 <- renderPlotly({ggplotly(ggplot(data=dataChr18, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr18$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,78077248) + labs(x='position',y='t score',title="chr18")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr18_chrom <- renderPlot(chromNumber("18"))
                dataChr19 <- percent_dat[percent_dat$chrom == 'chr19',]
                output$chr19 <- renderPlotly({ggplotly(ggplot(data=dataChr19, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr19$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,59128983) + labs(x='position',y='t score',title="chr19")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr19_chrom <- renderPlot(chromNumber("19"))
                dataChr20 <- percent_dat[percent_dat$chrom == 'chr20',]
                output$chr20 <- renderPlotly({ggplotly(ggplot(data=dataChr20, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr20$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,63025520) + labs(x='position',y='t score',title="chr20")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr20_chrom <- renderPlot(chromNumber("20"))
                dataChr21 <- percent_dat[percent_dat$chrom == 'chr21',]
                output$chr21 <- renderPlotly({ggplotly(ggplot(data=dataChr21, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr21$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,48129895) + labs(x='position',y='t score',title="chr21")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr21_chrom <- renderPlot(chromNumber("21"))
                dataChr22 <- percent_dat[percent_dat$chrom == 'chr22',]
                output$chr22 <- renderPlotly({ggplotly(ggplot(data=dataChr22, mapping=aes(x=start, y=t, text = paste0("gene:",dataChr22$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,51304566) + labs(x='position',y='t score',title="chr22")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chr22_chrom <- renderPlot(chromNumber("22"))
                dataChrX <- percent_dat[percent_dat$chrom == 'chrX',]
                output$chrX <- renderPlotly({ggplotly(ggplot(data=dataChrX, mapping=aes(x=start, y=t, text = paste0("gene:",dataChrX$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,155270560) + labs(x='position',y='t score',title="chrX")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chrX_chrom <- renderPlot(chromNumber("X"))
                dataChrY <- percent_dat[percent_dat$chrom == 'chrY',]
                output$chrY <- renderPlotly({ggplotly(ggplot(data=dataChrY, mapping=aes(x=start, y=t, text = paste0("gene:",dataChrY$gene))) +geom_point( color="red", size=0.1) +ylim(-15,15)+ xlim(0,59373566) + labs(x='position',y='t score',title="chrY")+theme(legend.position="blank",plot.title = element_text(hjust = 0.5)))})
                output$chrY_chrom <- renderPlot(chromNumber("Y"))
